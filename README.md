...
[![Tests](https://img.shields.io/badge/tests-330%20passing-brightgreen?style=flat-square&logo=vitest&logoColor=white)](#quality)
...
[![MCP tools](https://img.shields.io/badge/MCP%20tools-31-8A2BE2?style=flat-square&logo=anthropic&logoColor=white)](./plugins/uk-legal)
...
npm test               # vitest — 330 tests, upstreams stubbed (no network)
npm run test:coverage  # ~99% lines · ~98% functions · ~88% branches (gated)
npm run verify         # parity + smoke: 31 tools / 9 resources / 4 prompts
```
