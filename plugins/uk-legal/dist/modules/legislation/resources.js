...
export function registerResources(server, deps) {
    server.registerResource("UK Legislation Section (CLML XML)", new ResourceTemplate("legislation://{type}/{year}/{number}/section/{section}{?date}", { list: undefined }), {
        title: "UK Legislation Section (CLML XML)",
        description: "The CLML XML for one section of an Act or SI — for example, " +
    ...
    server.registerResource("UK Legislation Table of Contents", new ResourceTemplate("legislation://{type}/{year}/{number}/toc{?date}", { list: undefined }), {
        title: "UK Legislation Table of Contents",
        description: "A flattened table of contents — parts, chapters, sections and " +
