...
them directly.`,
        ...
        const text = "You are supporting a legal and policy team. Here is the policy under consideration:\n\n" +
            `${policy_description}\n\n` +
...
caller.`,
        ...
        const text = `Put together ${member_name}'s parliamentary record on '${topic}'. ` +
