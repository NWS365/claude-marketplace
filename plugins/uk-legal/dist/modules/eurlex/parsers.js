...
export function eurlexUrl(celex) {
...
export function parseSearchResults(query, raw) {
    const results = bindingsOf(raw).map((b) => {
 ...
 */
export function parseDocument(celex, raw) {
