...
const ABOUT = {
    name: "uk-legal",
    version: VERSION,
    origin: "Independent TypeScript implementation (Smartr365 legal-plugins marketplace). The OSCOLA citation patterns are compiled from primary sources (the neutral-citation Practice Direction, TNA Find Case Law, and OSCOLA 4th edn); no third-party server source is incorporated.",
